  ...
  \begin{minipage}{0.50\linewidth}
    ...
    \begin{table}[H]
      ...
      \begin{tabular}{r|cc} \toprule
        ...
        Zeros & \pair{7.7\cdot10^{-3}}{1.2\cdot10^{-3}} & \pair{1.4}{1.9\cdot10^{-1}} \\
        Gaussian & \pair{7.7\cdot10^{-3}}{1.4\cdot10^{-3}} & \pair{1.1}{2.0\cdot10^{-1}} \\
        Meta OT & \cellhi \pair{3.9\cdot10^{-3}}{1.6\cdot10^{-3}} & \cellhi \pair{0.44}{1.5\cdot10^{-1}} \\
        \bottomrule
      \end{tabular}}
...
\begin{figure}[t]
  ...
  \caption{
    ...
    The error here is the marginal error defined in \cref{eq:sinkhorn-err}.
  }
