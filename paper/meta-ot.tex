...
\begin{figure}[!t]
    \centering
    \hspace*{-1cm}
    \includegraphics[width=.25\linewidth]{fig/cross_domain_gauss_init/errs_doodles_doodles.pdf}
    \includegraphics[width=.25\linewidth]{fig/cross_domain_gauss_init/errs_doodles_mnist.pdf}
    \includegraphics[width=.25\linewidth]{fig/cross_domain_gauss_init/errs_doodles_usps28.pdf}
    \includegraphics[width=.25\linewidth]{fig/cross_domain_gauss_init/errs_doodles_random.pdf}

    \hspace*{-1cm}
    \includegraphics[width=.25\textwidth]{fig/mnist-errs.pdf}
    \includegraphics[width=.25\linewidth]{fig/cross_domain_gauss_init/errs_mnist_usps28.pdf}
    \includegraphics[width=.25\linewidth]{fig/cross_domain_gauss_init/errs_mnist_doodles.pdf}
    \includegraphics[width=.25\linewidth]{fig/cross_domain_gauss_init/errs_mnist_random.pdf}

    \hspace*{-1cm}
    \includegraphics[width=.25\linewidth]{fig/cross_domain_gauss_init/errs_usps28_usps28.pdf}
    \includegraphics[width=.25\linewidth]{fig/cross_domain_gauss_init/errs_usps28_mnist.pdf}
    \includegraphics[width=.25\linewidth]{fig/cross_domain_gauss_init/errs_usps28_doodles.pdf}
    \includegraphics[width=.25\linewidth]{fig/cross_domain_gauss_init/errs_usps28_random.pdf}

    \hspace*{-1cm}
    \includegraphics[width=.25\linewidth]{fig/cross_domain_gauss_init/errs_random_random.pdf}
    \includegraphics[width=.25\linewidth]{fig/cross_domain_gauss_init/errs_random_mnist.pdf}
    \includegraphics[width=.25\linewidth]{fig/cross_domain_gauss_init/errs_random_usps28.pdf}
    \includegraphics[width=.25\linewidth]{fig/cross_domain_gauss_init/errs_random_doodles.pdf}
